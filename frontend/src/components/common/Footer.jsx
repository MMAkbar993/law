          ...
          <div className="lg:w-2/3 grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link to="/news" className="transition-colors hover:text-brand-accent">
                    Blog
                  </Link>
                </li>
                <li>
                  <Link to="/disclaimer-and-terms-of-use" className="transition-colors hover:text-brand-accent">
                    Terms of Use
                  </Link>
                </li>
              </ul>
