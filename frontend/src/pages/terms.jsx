      ...
      <div className="container mx-auto max-w-4xl px-4 py-12 md:py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              This Site is designed to be accessible to and usable by people with and without disabilities. Please call us at <a href="tel:4074201414" className="text-blue-600 hover:text-blue-700 underline">(407) 420-1414</a> or <a href="mailto:contact@forthepeople.com" className="text-blue-600 hover:text-blue-700 underline">email us</a> if you encounter an accessibility or usability issue on this site.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              The Site and MM software, systems, technology, and know-how (<strong>"MM Technology"</strong>) are owned by or licensed to MM and are protected by copyright, trademark, trade dress, patent, and/or other intellectual property rights and proprietary rights. All trademarks, trade names, graphics, logos, and trade dress included in or made available through the Site and Online Services are owned by or licensed to MM and protected by U.S. and international trademark laws (collectively, the <strong>"Marks"</strong>).
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Please review our Privacy Policy as posted on the Site (the "Privacy Policy"), which is incorporated herein and also governs your use of the Site, to understand MM's privacy practices <Link to="/privacy-policy" className="text-blue-600 hover:text-blue-700 underline">https://www.forthepeople.com/privacy-policy/</Link>.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
              <li>reproduce, distribute, publically display, or otherwise transfer the Site;</li>
              <li>adapt, alter, modify, reverse engineer, disassemble, or decompile the Site;</li>
              <li>prepare derivative works based on the Site or any MM technology;</li>
              <li>remove, obscure, or modify any copyright, trademark or other proprietary rights notices, marks or labels contained on or within the Site;</li>
              <li>frame, mirror, or in-line link the Site, or incorporate into another website, application, or other service any MM intellectual property;</li>
              <li>use the Site for any unlawful, fraudulent, or malicious purposes, or to solicit any such activity;</li>
              <li>attempt to gain unauthorized access to any accounts, features, systems, or networks through hacking, password mining, or any other means;</li>
              <li>interfere with any access control measures or attempt to disable or circumvent such security features;</li>
              <li>post, transmit, submit, or include any unlawful, harmful, threatening, abusive, harassing, defamatory, vulgar, obscene, sexually explicit, profane, hateful, racially, ethnically, or otherwise objectionable content, material, or information of any kind, or any content, material, or information that may give rise to criminal or civil liability;</li>
              <li>submit or post any false or misleading information; and/or</li>
              <li>violate, infringe, or misappropriate the intellectual property, publicity, privacy, or other proprietary rights of MM, its licensors, or any other person or entity.</li>
            </ul>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Some materials on the Platform may constitute lawyer advertising. The choice of a lawyer is an important decision, and it should never be based solely upon an advertisement. Before making your choice of any attorney, you should give this matter careful thought. The selection of an attorney is an important decision. Cases will be handled by attorneys licensed in the local jurisdiction.. Before you decide, you may ask us to send you free written information about our qualifications and experience. <strong>FREE BACKGROUND INFORMATION IS AVAILABLE UPON REQUEST.</strong> No representation is made that the lawyers are certified specialists or experts in any field of law. And no representation is made that the legal services to be performed are greater than the quality of legal services performed by other lawyers. Anyone considering a lawyer should independently investigate the lawyer's credentials and ability, and not rely upon advertisements or self-proclaimed expertise. No representation is made here about your specific rights. Every case is different and must be judged on its own merits. Prior results do not guarantee a similar outcome. Contingent attorney fees are negotiable and not set by law. Costs and fees are charged only upon monetary recovery. Not available in all states. Cases may be handled in association with, or referred to, other law firms as co-counsel or referral counsel. Only the law firm's non-lawyer staffed call center is open 24 hours a day / 7 days a week.
            </p>
            <div className="mt-6 space-y-2 text-gray-700">
              <p><strong>Alabama:</strong> Erby Fischer, Esq., 216 Summit Blvd, Suite 300, Birmingham, Alabama 35243</p>
              <p><strong>Arkansas:</strong> Bobby F. Martin, Jr., Esq., 400 West Capitol Avenue, Suite 1700 Little Rock, Arkansas 72201</p>
              <p><strong>Arizona:</strong> Steven Jones, 2355 E Camelback Rd Suite 335, Phoenix, AZ 85016</p>
              <p><strong>California:</strong> 633 West Fifth Street, Suite 2200, Los Angeles, California 90071</p>
              <p><strong>Georgia:</strong> 191 Peachtree St NE, #4200, Atlanta, Georgia 30303</p>
              <p><strong>Indiana:</strong> 117 East Washington Street, Suite 201, Indianapolis, Indiana 46204</p>
              <p><strong>Michigan:</strong> Michael Hanna, Esq., 150 W Jefferson Ave Ste 1400, Detroit, MI 48226</p>
              <p><strong>Mississippi:</strong> 4450 Old Canton Rd Suite 200, Jackson, Mississippi 39211</p>
              <p><strong>New Jersey:</strong> David D. Friedman, Esq 30 Montgomery Street, Suite 410, Jersey City, New Jersey 07302</p>
              <p><strong>New York:</strong> 199 Water St, Suite 1500, New York, New York 10038. <a href="tel:2128452800" className="text-blue-600 hover:text-blue-700 underline">212-845-2800</a></p>
              <p><strong>North Carolina:</strong> Jonathan M. Smith, Esq., 9121 Anson Way, Suite 200, Raleigh, North Carolina 27615</p>
              <p><strong>Pennsylvania:</strong> 2005 Market Street, Suite 350, Philadelphia, PA 19103.</p>
              <p><strong>South Carolina:</strong> Joe Sandefur, Esq. 11915 Plaza Dr., Suite 301, Murrells Inlet, SC 29576.</p>
              <p><strong>Texas:</strong> 16255 Park Ten Pl Suite 500, Houston, TX 77084</p>
              <p><strong>Vermont:</strong> 106 Main St, 2nd Office 7W, Burlington, Vermont 05401</p>
              <p><strong>West Virginia:</strong> 222 Capitol Street, Suite 200A, Charleston, West Virginia 25301</p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              <strong>For Employees Only</strong>
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              To view our Mobile Terms and Conditions please visit our <Link to="/disclaimer-and-terms-of-use" className="text-blue-600 hover:text-blue-700 underline">Mobile Terms and Conditions</Link> page.
            </p>
          </section>
